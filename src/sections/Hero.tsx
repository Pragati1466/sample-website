    ...
    return (
        ...
        >
            <div className="text-center">
                ...
                <button className="bg-gradient-to-r from-purple-600 to-blue-500 text-white border-2 border-white font-semibold py-2 px-6 rounded-full mb-4 opacity-100 pointer-events-none" style={{ cursor: 'default' }}>
